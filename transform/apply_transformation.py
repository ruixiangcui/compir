...
flags.DEFINE_string("lang", "", "language of the data.")
flags.DEFINE_string("train_data_path", "", "Path to the training data.")
flags.DEFINE_string("dev_data_path", "", "Path to the dev data.")
...
def main(argv):
  ...
  apply_transformation_utils.transform(FLAGS.dataset, FLAGS.split, FLAGS.lang,
