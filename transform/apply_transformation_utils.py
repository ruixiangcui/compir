...
def transform(dataset,
  ...
  parser = dataset_parser_utils.get_parser(dataset)(train_examples, dev_examples,
                                                    test_examples)
  ...
  if transformation == "none" or transformation == "lirind":
    ...
    train_examps_processed, dev_examps_processed, test_examps_processed = parser.to_reversible()
  ...
  output_file = os.path.join(
      output_path, split + "_" + transformation + "_" + lang + "_{}.tsv")
  io_utils.write_to_tsv(train_examps_processed, output_file.format("train"))
  io_utils.write_to_tsv(dev_examps_processed, output_file.format("dev"))
